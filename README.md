# :beers: งานเลี้ยงย่อมมีวันเลิกรา All good things must come to an end.
ขอบคุณทุก ๆ คนที่มีส่วนร่วมในการส่งต่อ invite ด้วยครับ ถ้าขาดพวกคุณคนใดคนหนึ่งไป กลุ่มนี้จะไร้ความหมายทันทีเลยครับ
...
![alt text](https://github.com/linesquareToClubhouse/clubHouseInviteRules/blob/main/images/cloneCount.jpg "clone count")
-มีคนเข้ามาดูแบบไม่ซ้ำหน้าประมาณ2500คน โดยเฉลี่ยหนึ่งคนจะกดดูสามครั้ง
-ช่วงวันที่สามของกลุ่ม(18กุมภาพันธ์) เป็นช่วงที่คนเข้ามาดูสูงที่สุด โดยมีผู้เข้ามาดูไม่ซ้ำหน้า 800 คน
-มีคนcloneโน้ตกลุ่ม 22 คน โดยเฉลี่ยหนึ่งคนจะกดclone 2-3 ครั้ง

## 👑 Top contributors
![alt text](https://github.com/linesquareToClubhouse/clubHouseInviteRules/blob/main/images/topContributor.jpg "top contributor")
