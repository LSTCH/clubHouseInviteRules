...
> ตัวอย่าง: มีหมายเลขคิวที่  ```800```  ซ้ำกันสองคน
> คนที่มาก่อน (คอมเมนท์คิวอยู่ด้านบน) ให้ตั้งชื่อเป็น  ```800.1```
> คนที่มาทีหลัง (คอมเมนท์คิวอยู่ด้านล่าง) ให้ตั้งชื่อเป็น  ```800.2```
