...
ไม่มีงานเลี้ยงใดที่ไร้ซึ่งวันเลิกรา ขอบคุณทุก ๆ คนที่มีส่วนร่วมในการส่งต่อ invite ด้วยครับ ถ้าขาดพวกคุณคนใดคนหนึ่งไป การส่งต่ออาจไม่เกิดขึ้นได้เลยครับ
...
-ช่วงวันที่สองของกลุ่ม(18กุมภาพันธ์) เป็นช่วงที่พีคที่สุด มีผู้เข้ามาดูไม่ซ้ำหน้า 800 คน
-มีคนcloneโน้ตกลุ่ม 22 คน โดยเฉลี่ยหนึ่งคนจะกดclone 2-3 ครั้ง

## Top contributors
..inserrt image here..<br/>
ขอขอบคุณ คุณBubuuuuu มากครับ คุณBubuuuuu ช่วยรันคิวตั้งแต่คิวที่ 1000 จนถึงคิวสุดท้ายเลย
